  ...
  return(
    ...
    <ol>
        <li className="ol-flex">
            <p>01</p>
            <dl>
                <dt><em className="dot">自分</em>を知る</dt>
                <dd>
                    自分の能力に近い
                    <br />
                    SOLTILOのOG・OBを紹介
        ...
        <li className="ol-flex">
            <dl>
                <dt><em className="dot">苦手</em>を知る</dt>
                <dd>
                    苦手を克服するための
                    <br />
                    おすすめトレーニングを紹介
                </dd>
                <dd className="dd-primary">苦手の対策方法を知る</dd>
            </dl>
            <p>02</p>
        </li>
        ...
        <li className="ol-flex">
            <p>03</p>
            <dl>
                <dt><em className="dot">得意</em>を知る</dt>
                <dd>
                    得意を一緒に伸ばしていく
                    <br />
                    優秀なスタッフを紹介
